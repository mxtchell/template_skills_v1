...
# MAIN SKILL
@skill(
    name="Sixt Plan Drivers Fixed",
    llm_name="sixt_plan_driver_analysis_fixed",
...
def sixt_plan_drivers_fixed(parameters: SkillInput):
...
if __name__ == '__main__':
    skill_input: SkillInput = sixt_plan_drivers_fixed.create_input(
        arguments={
            "breakouts": [
                "brnc_name"
            ],
    ...
    out = sixt_plan_drivers_fixed(skill_input)
    preview_skill(sixt_plan_drivers_fixed, out)